...
import { LinearGradient } from 'expo-linear-gradient'; // Assuming expo-linear-gradient is available, if not I will use a solid color fallback or check package.json. 
// Actually, to be safe and avoid adding dependencies without checking, I'll stick to solid colors or simple gradients if possible, 
            ...
            <View style={styles.statsRow}>
              {memberSince && (
                <View style={styles.statItem}>
                  <Ionicons name="calendar-outline" size={16} color="#fff" style={{ opacity: 0.8 }} />
                  <Text style={styles.statText}>Joined {memberSince}</Text>
                </View>
              )}
              <View style={styles.statDivider} />
              <View style={styles.statItem}>
                <Ionicons name="bed-outline" size={16} color="#fff" style={{ opacity: 0.8 }} />
                <Text style={styles.statText}>Room {me?.roomNumber || "N/A"}</Text>
              </View>
            </View>
          </View>
        </View>
